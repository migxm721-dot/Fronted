        ...
        >
          ...
          >
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity
                style={[styles.signupButtonOrange, loading && styles.buttonDisabled]}
...
const styles = StyleSheet.create({
  ...
  logo: { width: 140, height: 140, marginBottom: 15, marginTop: 20 },
  title: {
    fontSize: 28,
    fontWeight: 'bold',
    color: '#fff',
  ...
  privacyText: { color: 'rgba(255,255,255,0.7)', fontSize: 12, fontWeight: '600' },
